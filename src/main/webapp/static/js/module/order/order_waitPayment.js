        ...
        tableIns=table.render({
            ...
            response:{
             ...
             cols: [[
                 ...
                 ,{field:'xdRequirement', title: '评论链接',align:'center'}
                 ,{field:'xdRequirement', title: '评论状态',align:'center'}
...
function opt(obj,id) {
    if(null!=id){
        layer.confirm('您确定要收款吗？', {
            btn: ['确认','返回'] //按钮
        }, function(){
            $.post("/rec/order/updateStatus",{"id":id,"status":6},function(data){
                if (data.code == 200) {
