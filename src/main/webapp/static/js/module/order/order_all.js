    ...
    layui.use('table', function(){
        ...
        tableIns=table.render({
            ...
            cols: [[
                ...
                ,{field:'recPrice', title: '接单金额',align:'center'}
                ,{field:'xdPrice', title: '下单金额',align:'center'}
                ,{field:'sellerWXQQ', title: '卖家',align:'center'}
                ,{field:'sellerOrderType', title: '类型',align:'center'}
                ,{field:'goodOrderNum', title: '订单号',align:'center'}
                ,{field:'workerName', title: '员工代码',align:'center'}
                ,{field:'workerName', title: '购买ID',align:'center'}
                ,{field:'xdRequirement', title: '下单要求',align:'center'}
                ,{field:'remark', title: '备注',align:'center'}
                ,{field:'status', title: '状态',align:'center'}
                ,{field:'flag', title: '额外要求',align:'center'}
                ,{title:'操作',width: 200,align:'center', toolbar:'#optBar'}
            ]],
