        ...
        tableIns=table.render({
            ...
            response:{
             ...
             cols: [[
                 ...
                 ,{field:'flag', title: '截图',align:'left',width:100,templet: function(d){
                                                                                         return '<div>' +
                                                                                         '<a href="'+ d.xdJtUrl+'">下单截图</a></br>' +
                                                                                         '<a href="'+ d.xdPayedJtUrl+'">下单付款截图</a></br>' +
                                                                                         '</div>'
                                                                                         }}
...
function opt(obj,id) {
    if(null!=id){
        layer.confirm('您确定要反馈吗？', {
            ...
            $.post("/rec/order/updateStatus",{"id":id,"status":2},function(data){
                if (data.code == 200) {
